 ...
 * @param displayName Name of item displayed by frontend.
...
/**
 * @param id ID of item. Autogenerated and unique.
 * @param name: Name of item.
 * @param itemName: Name of item as frontend would display it.
 ...
 * @param schedule List of entries in the schedule table.
 ...
 * @param name Name of Item borrowed.
 * @param itemId ID of Item borrowed.
